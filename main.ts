...
const tx = await evmprovider.getTXReceiptByHash("0xa82791bb02323ead8caa02adadd9fa2fde015d81bc170e5fd484306d060d016e");
const recepit = await evmprovider.getTransactionByHash("0xa82791bb02323ead8caa02adadd9fa2fde015d81bc170e5fd484306d060d016e");
console.log(`tx: ${tx}\nreceipt: ${recepit}`);
}
