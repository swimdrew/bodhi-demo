...
function _ownExposures(instanceId, api) {
  ...
  return (0, _util.memo)(instanceId, (accountId, eras, _withActive) => eras.length ? api.queryMulti([...eras.map(e => [api.query.staking.erasStakersClipped, [e, accountId]]), ...eras.map(e => [api.query.staking.erasStakers, [e, accountId]])]).pipe((0, _rxjs.map)(all => eras.map((era, index) => ({
    clipped: all[index],
    era,
