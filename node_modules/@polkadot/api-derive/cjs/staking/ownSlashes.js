...
function _ownSlashes(instanceId, api) {
  ...
  return (0, _util.memo)(instanceId, (accountId, eras, _withActive) => eras.length ? api.queryMulti([...eras.map(e => [api.query.staking.validatorSlashInEra, [e, accountId]]), ...eras.map(e => [api.query.staking.nominatorSlashInEra, [e, accountId]])]).pipe((0, _rxjs.map)(values => eras.map((era, index) => ({
    era,
