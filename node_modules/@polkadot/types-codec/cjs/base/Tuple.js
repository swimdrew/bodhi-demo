...
function decodeTuple(registry, Classes, value) {
  if ((0, _util.isU8a)(value) || (0, _util.isHex)(value)) {
    return (0, _utils.decodeU8a)(registry, (0, _util.u8aToU8a)(value), Classes);
  }
...
class Tuple extends _AbstractArray.AbstractArray {
  ...
  constructor(registry, Types, value) {
    const Classes = Array.isArray(Types) ? Types.map(t => (0, _utils.typeToConstructor)(registry, t)) : (0, _util.isFunction)(Types) || (0, _util.isString)(Types) ? [(0, _utils.typeToConstructor)(registry, Types)] : (0, _utils.mapToTypeMap)(registry, Types);
    const [values, decodedLength] = (0, _util.isU8a)(value) ? (0, _utils.decodeU8a)(registry, value, Classes) : decodeTuple(registry, Classes, value);
  ...
  toU8a(isBare) {
    return (0, _util.u8aConcat)(...this.toU8aInner(isBare));
  }
