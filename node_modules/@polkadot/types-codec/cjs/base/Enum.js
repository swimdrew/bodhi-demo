...
function extractDef(registry, _def) {
  ...
  if (Array.isArray(_def)) {
    ...
    const entries = Object.entries((0, _utils.mapToTypeMap)(registry, _def));
...
class Enum {
  ...
  _toRawStruct() {
    ...
    const typeMap = Object.entries(this.#def).reduce((out, _ref3) => {
      let [key, {
        Type
      }] = _ref3;
      out[key] = Type;
    ...
    return (0, _utils.typesToMap)(this.registry, typeMap);
  }
  /**
  ...
  toU8a(isBare) {
    return (0, _util.u8aConcat)(new Uint8Array(isBare ? [] : [this.index]), this.#raw.toU8a(isBare));
  }
