...
function decodeMapFromU8a(registry, KeyClass, ValClass, u8a) {
  ...
  const [values, decodedLength] = (0, _utils.decodeU8a)(registry, u8a.subarray(offset), types);
...
class CodecMap extends Map {
  ...
  constructor(registry, keyType, valType, rawValue) {
    ...
    this.#KeyClass = (0, _utils.typeToConstructor)(registry, keyType);
    this.#ValClass = (0, _utils.typeToConstructor)(registry, valType);
    this.#type = type;
  }
  /**
