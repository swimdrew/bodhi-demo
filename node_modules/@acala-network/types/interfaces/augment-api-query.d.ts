...
declare module '@polkadot/api-base/types/storage' {
    interface AugmentedQueries<ApiType extends ApiTypes> {
        ...
        assetRegistry: {
             ...
             **/
            assetMetadatas: AugmentedQuery<ApiType, (arg: ModuleAssetRegistryModuleAssetIds | {
                Erc20: any;
            } | {
                StableAssetId: any;
            } | {
                ...
                NativeAssetId: any;
            } | string | Uint8Array) => Observable<Option<ModuleAssetRegistryModuleAssetMetadata>>, [ModuleAssetRegistryModuleAssetIds]> & QueryableStorageEntry<ApiType, [ModuleAssetRegistryModuleAssetIds]>;
            /**
            ...
            locationToCurrencyIds: AugmentedQuery<ApiType, (arg: XcmV1MultiLocation | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array) => Observable<Option<AcalaPrimitivesCurrencyCurrencyId>>, [XcmV1MultiLocation]> & QueryableStorageEntry<ApiType, [XcmV1MultiLocation]>;
            /**
        ...
        cdpEngine: {
            ...
            collateralParams: AugmentedQuery<ApiType, (arg: AcalaPrimitivesCurrencyCurrencyId | {
                ...
                ForeignAsset: any;
            } | string | Uint8Array) => Observable<ModuleCdpEngineRiskManagementParams>, [AcalaPrimitivesCurrencyCurrencyId]> & QueryableStorageEntry<ApiType, [AcalaPrimitivesCurrencyCurrencyId]>;
            /**
        ...
        incentives: {
             ...
             **/
            claimRewardDeductionRates: AugmentedQuery<ApiType, (arg: ModuleIncentivesPoolId | {
                Loans: any;
            } | {
                Dex: any;
            } | string | Uint8Array) => Observable<u128>, [ModuleIncentivesPoolId]> & QueryableStorageEntry<ApiType, [ModuleIncentivesPoolId]>;
            /**
             * Mapping from pool to its fixed reward rate per period.
             *
             * DexSavingRewardRates: map Pool => SavingRatePerPeriod
             **/
            dexSavingRewardRates: AugmentedQuery<ApiType, (arg: ModuleIncentivesPoolId | {
                Loans: any;
            } | {
                Dex: any;
            } | string | Uint8Array) => Observable<u128>, [ModuleIncentivesPoolId]> & QueryableStorageEntry<ApiType, [ModuleIncentivesPoolId]>;
             ...
             **/
            incentiveRewardAmounts: AugmentedQuery<ApiType, (arg1: ModuleIncentivesPoolId | {
                Loans: any;
            } | {
                Dex: any;
                ...
                ForeignAsset: any;
            } | string | Uint8Array) => Observable<u128>, [ModuleIncentivesPoolId, AcalaPrimitivesCurrencyCurrencyId]> & QueryableStorageEntry<ApiType, [ModuleIncentivesPoolId, AcalaPrimitivesCurrencyCurrencyId]>;
            /**
             ...
             **/
            pendingMultiRewards: AugmentedQuery<ApiType, (arg1: ModuleIncentivesPoolId | {
                Loans: any;
            } | {
                Dex: any;
            } | string | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<BTreeMap<AcalaPrimitivesCurrencyCurrencyId, u128>>, [ModuleIncentivesPoolId, AccountId32]> & QueryableStorageEntry<ApiType, [ModuleIncentivesPoolId, AccountId32]>;
            /**
             * Generic query
             **/
            [key: string]: QueryableStorageEntry<ApiType>;
        ...
        loans: {
            ...
            positions: AugmentedQuery<ApiType, (arg1: AcalaPrimitivesCurrencyCurrencyId | {
                ...
                ForeignAsset: any;
            } | string | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<ModuleLoansPosition>, [AcalaPrimitivesCurrencyCurrencyId, AccountId32]> & QueryableStorageEntry<ApiType, [AcalaPrimitivesCurrencyCurrencyId, AccountId32]>;
            /**
            ...
            totalPositions: AugmentedQuery<ApiType, (arg: AcalaPrimitivesCurrencyCurrencyId | {
                ...
                ForeignAsset: any;
            } | string | Uint8Array) => Observable<ModuleLoansPosition>, [AcalaPrimitivesCurrencyCurrencyId]> & QueryableStorageEntry<ApiType, [AcalaPrimitivesCurrencyCurrencyId]>;
            /**
             * Generic query
             **/
            [key: string]: QueryableStorageEntry<ApiType>;
        ...
        rewards: {
             ...
             * map PoolId => PoolInfo
             **/
            poolInfos: AugmentedQuery<ApiType, (arg: ModuleIncentivesPoolId | {
                Loans: any;
            } | {
                Dex: any;
            } | string | Uint8Array) => Observable<OrmlRewardsPoolInfo>, [ModuleIncentivesPoolId]> & QueryableStorageEntry<ApiType, [ModuleIncentivesPoolId]>;
            /**
             ...
             **/
            sharesAndWithdrawnRewards: AugmentedQuery<ApiType, (arg1: ModuleIncentivesPoolId | {
                Loans: any;
            } | {
                Dex: any;
            } | string | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<ITuple<[u128, BTreeMap<AcalaPrimitivesCurrencyCurrencyId, u128>]>>, [ModuleIncentivesPoolId, AccountId32]> & QueryableStorageEntry<ApiType, [ModuleIncentivesPoolId, AccountId32]>;
            /**
             * Generic query
             **/
            [key: string]: QueryableStorageEntry<ApiType>;
        ...
        xcmInterface: {
            ...
            xcmDestWeightAndFee: AugmentedQuery<ApiType, (arg: ModuleXcmInterfaceModuleXcmInterfaceOperation | {
                ...
                ParachainFee: any;
            } | string | Uint8Array) => Observable<ITuple<[u64, u128]>>, [ModuleXcmInterfaceModuleXcmInterfaceOperation]> & QueryableStorageEntry<ApiType, [ModuleXcmInterfaceModuleXcmInterfaceOperation]>;
            /**
             * Generic query
             **/
            [key: string]: QueryableStorageEntry<ApiType>;
